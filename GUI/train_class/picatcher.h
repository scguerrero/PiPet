...
// ─── piCatcher: outer widget (mirrors Battle / minigame_2) ───

class piCatcher : public QWidget
{
    Q_OBJECT

public:
    explicit piCatcher(PiPet* pet, QWidget* parent = nullptr,
                        int canvasW = 600, int canvasH = 300);
    ~piCatcher() override = default;
