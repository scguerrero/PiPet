...
BattleWindow::BattleWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    connect(btnAttack,  &QPushButton::clicked, this, &BattleWindow::onAttack);
    connect(btnCharge,  &QPushButton::clicked, this, &BattleWindow::onCharge);
    connect(btnDefend,  &QPushButton::clicked, this, &BattleWindow::onDefend);
    connect(btnRestart, &QPushButton::clicked, this, &BattleWindow::onRestart);
...
void BattleWindow::onAttack()  { playTurn(Move::Attack); }
void BattleWindow::onCharge()  { playTurn(Move::Charge); }
void BattleWindow::onDefend()  { playTurn(Move::Defend); }

void BattleWindow::onRestart()
{
...
void BattleWindow::playTurn(Move pm)
{
    QString result, log;
